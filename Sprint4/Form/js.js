const crearDiv=()=>{
    ...
    if(numDivs < 10){
        ...
        let id = idDiv();
        let nuevoDiv = '<div id="'+id+'" class="item">Este es el DIV con el id <strong>'+id +'</strong> <input type="button" class="eliminar" onClick="eliminarDiv(this)" value="Eliminar este DIV"></div>';
